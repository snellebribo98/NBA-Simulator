...
//
//  This class shows the player details of the player pressed in the previous tableview controller
...
class PlayerDetailVC: UIViewController {
    ...
    /// initializes view controller and calls the update function
    ...
    /// show player data filtered for incorrect information
    func updateUI() {
        team()
    ...
    /// assigns the teamID to right team fullname
    func team() {
    ...
    /// if the player firstname is the nickname change the textlabels
    func lastname() {
    ...
    /// if height and weight are - name them unknown
    /// otherwise show their height in feet and weight in lbs
    func playermetric() {
    ...
    /// if player country is drc change it otherwise show given country
    func playerCountry() {
    ...
    /// if playercollege is birthplace show that player didn't attend college
    /// otherwise show college player went to
    func playerCollege() {
    ...
    /// if player stats are -1 show that the player has no stats
    ...
    /// assigns the right layout to the right team
    func teamLooks()
    {
